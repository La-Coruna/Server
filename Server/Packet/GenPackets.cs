...
class C_Chat : IPacket
{
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        ushort chatLen = (ushort)Encoding.Unicode.GetBytes(this.chat, 0, this.chat.Length, segment.Array, segment.Offset + count + sizeof(ushort)); // + sizeof(ushort)를 한 이유는 길이가 들어갈 공간을 비워두기 위해서.
